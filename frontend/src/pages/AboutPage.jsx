              ...
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full sm:w-auto bg-[#006494] hover:bg-[#003554] disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium py-2.5 sm:py-2 px-6 rounded text-sm transition-colors flex items-center justify-center"
                  >
                    {isLoading ? (
                      <>
