        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="xl:col-span-1">
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6 sticky top-4 sm:top-24">
              ...
              {/* Continue Shopping */}
              <button className="w-full mt-4 py-3 px-6 border-2 border-gray-300 rounded-lg font-semibold hover:border-gray-400 transition-colors" onClick={continueShopping} >
                Continue Shopping
              </button>
            </div>
          </div>
